...
public class App {
    ...
    public static void main(String[] args) {
        ...
        if (os_name.toLowerCase().startsWith("win")) {
            System.out.println(os_name + " is windows environment");
        }
        ArrayList<String[]> config_string_array = new ArrayList<>();//CsvHander.csv_reader(app_path + File.separator + "config.csv");
        ...
        arrayList = new ArrayList<>(Arrays.asList(
            "http://www.ppsbbs.tech",
            "http://www.ppsbbs.tech/forum-1.htm",
            "http://www.ppsbbs.tech/forum-2.htm",
            "http://www.ppsbbs.tech/forum-3.htm",
            "http://www.ppsbbs.tech/forum-4.htm",
            "http://www.ppsbbs.tech/forum-5.htm",
            "http://www.ppsbbs.tech/forum-6.htm",
            "http://www.ppsbbs.tech/forum-7.htm",
